...
//import com.gome.meidian.shiroredis.utils.JedisUtils;
//import com.gome.meidian.shiroredis.utils.SerializeUtils;
//
...
//		} finally {
//			jedisUtils.returnResource(jedis,true);
//		}
//
//		return session;
//	}
...
//				jedis = jedisUtils.getResource();
//				jedis.setex(prefix + session.getId(), seconds,
//						SerializeUtils.serializeToString((Serializable) session));
//				logger.info("sessionId {} name {} 作为非ShiroSession对象被更新, ", session.getId(),
